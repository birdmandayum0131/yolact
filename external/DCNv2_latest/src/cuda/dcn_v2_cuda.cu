                    ...
                    const int deformable_group)
{
    ...
    cublasOperation_t op2 = _cublasOpFromChar('n');
    ...
    THCudaBlas_SgemmBatched(state,
                            ...
                            batch);
    */
    cublasSgemmBatched(handle, op, op2, n_, m_, k_, &alpha, ones_b, k_, bias_b, k_, &theta,output_b, n_, batch);
    ...
    THCudaBlas_SgemmBatched(state,
                            ...
                            batch);
    */
    cublasSgemmBatched(handle, op2, op2, n, m, k, &alpha, (const float **)columns_b, n, weight_b, k, &beta,output_b, n, batch);
                                             ...
                                             int deformable_group)
{
    ...
    for (int b = 0; b < batch; b++)
    {
        ...
        */
        cublasSgemm(handle, op2, op, n, m, k, &alpha, grad_output_n.data<scalar_t>(), n, weight.data_ptr<scalar_t>(), m, &theta,columns.data_ptr<scalar_t>(), n);
        ...
        long long m_ = channels_out;
        long long n_ = channels * kernel_h * kernel_w;
        long long k_ = height_out * width_out;
        /*
        ...
        */
        ...
        cublasSgemm(handle, op, op2, n_, m_, k_, &alpha, columns.data_ptr<scalar_t>(), k_, grad_output_n.data_ptr<scalar_t>(), k_, &beta,grad_weight.data_ptr<scalar_t>(), n_);
